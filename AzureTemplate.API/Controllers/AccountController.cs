...
namespace AzureTemplate.API.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterRequest model)
        {
            ...
            //Example: Only allow users who's email address ends with a '@AzureTemplateapp.com'
            ...
            if (result.Succeeded)
            {
                ...
                // AzureTemplate.Database.Note tutorialNote = new AzureTemplate.Database.Note()
                // {
                //     OwnerId = newUser.Id,
                //     Title = "Getting Started",
                //     Content = "Welcome to AzureTemplate!\n\nUse AzureTemplate to keep notes. You can create note or lists. You can share your notes with other people (this comes in handy if you need a shared grocery list).\n\nThis video shows a quick demo on how to use AzureTemplate:\n\nhttps://AzureTemplate.org#HowTo",
                //     Color = "#39FF14",
                //     SortOrder = 2                 
                // };
                ...
                // AzureTemplate.Database.Note tutorialList = new AzureTemplate.Database.Note()
                // {
                //     OwnerId = newUser.Id,
                //     Title = "Shopping List",
                //     ListEnabled = true,
