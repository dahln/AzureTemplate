...
builder.Services.AddSwaggerGen(c => { 
        c.SwaggerDoc("v1", new OpenApiInfo { Title = "AzureTemplate API", Version = "v1" }); 
...
//Host the AzureTemplate.App files in the same 'Server' process as the API.
app.MapStaticAssets();
app.UseRouting();
...
//Necessary For the AzureTemplate.App
