...
namespace AzureTemplate.Database.Migrations
{
    ...
    [Migration("20250424020442_AddCustomerFiles")]
    partial class AddCustomerFiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AzureTemplate.Database.Customer", b =>
                {
            ...
            modelBuilder.Entity("AzureTemplate.Database.CustomerFile", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("AzureTemplate.Database.SystemSetting", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("AzureTemplate.Database.CustomerFile", b =>
                {
                    b.HasOne("AzureTemplate.Database.Customer", "Customer")
